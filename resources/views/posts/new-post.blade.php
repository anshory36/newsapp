            ...
            <div class="card-body">
                <form action="{{route('save-post')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-md-10">
                            <input name="post_title" required type="text" class="form-control" id="post_title" placeholder="Post Title">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-md-10">
                            <textarea name="post_content" required class="form-control" cols="30" rows="10" id="post_content" placeholder="Post Content">
                            </textarea>
                        </div>
                    </div>
